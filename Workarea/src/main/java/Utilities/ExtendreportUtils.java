 ...
 * 
 * ExtentSparkReporter sparkReporter; ExtentReports reports; ExtentTest test;
 * 
 * public void configureReport() { Date date = new Date(); SimpleDateFormat
 * formatter = new SimpleDateFormat("ddMMyyyy_hhmmss"); String strDate =
 * formatter.format(date);
 * 
 * File reportPath = new File(System.getProperty("user.dir") +
 * "//ExtentReport");
 * 
 * if (!reportPath.exists()) { reportPath.mkdir(); }
 * 
 * // create file sparkReporter = new ExtentSparkReporter(
 * System.getProperty("user.dir") + "//ExtentReport//" + "ExtentReport_" +
 * strDate + ".html"); reports = new ExtentReports();
 * reports.attachReporter(sparkReporter);
 * 
 * // System details reports.setSystemInfo("PC Name", "Jyothi");
 ...
 * reports.createTest(result.getName()); test.log(Status.PASS,
 * MarkupHelper.createLabel("Name of the Passed Test Case is : " +
 * result.getName(), ExtentColor.GREEN));
 * 
 * }
 * 
 * public void onTestFailure(ITestResult result) { test =
 * reports.createTest(result.getName()); test.log(Status.FAIL,
 * MarkupHelper.createLabel("Name of the Failed Test Case is : " +
 * result.getName(), ExtentColor.RED));
 * 
 * }
 * 
 * public void onTestSkipped(ITestResult result) { test =
 * reports.createTest(result.getName()); test.log(Status.SKIP,
 * MarkupHelper.createLabel("Name of the skipped test case is : " +
 ...
 * 
 * public void onFinish(ITestContext context) { reports.flush(); }
 * 
 * }
 */